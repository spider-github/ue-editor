...
UE.I18N['en'] = {
    ...
    'insertimage': {
        ...
        // dialogs 上传队列剩余文件提示
        'queueError': '_ file(s) are still waiting to upload',
    ...
    'insertvideo': {
        'static': {
            ...
            // dialogs/video/video.html 上传页签与外链说明
            'lang_select_video': 'Select Video',
            'lang_external_video_support': 'External video supports: Youku, Tencent Video, Bilibili'
        },
        'numError': "Please enter the correct Num. e.g 123,400",
    ...
    'insertaudio': {
        'static': {
            'lang_tab_insertV': "Audio",
            'lang_tab_uploadV': "Upload",
            'lang_audio_url': "Audio URL",
            'lang_alignment': "Alignment",
            'lang_input_fileStatus': ' No file uploaded!',
            'startUpload': {'style': "background:url(upload.png) no-repeat;"},
            'lang_upload_alignment': "Alignment",
            // dialogs/audio/audio.html 上传页签与外链说明
            'lang_select_audio': 'Select Audio',
            'lang_external_audio_support': 'External audio supports MP3 format'
        },
        'floatLeft': "Float left",
        'floatRight': "Float right",
        'default': "Default",
        'block': "Display in block",
        'urlError': "The audio url format may be wrong!",
        'uploadSelectFile': 'Select File',
        'uploadAddFile': 'Add File',
        'uploadStart': 'Start Upload',
        'uploadPause': 'Pause Upload',
    ...
    // dialogs/ai/* AI 生成弹窗文案
    'ai': {
        'static': {
            'lang_input_placeholder': {placeholder: 'Tell AI what to do next, for example: translate this into English'},
            'lang_result_title': 'Generated result',
            'lang_insert': 'Insert',
            'lang_replace': 'Replace',
            'lang_tip_with_actions': 'Tip: You can type above to generate content or choose an action below',
            'lang_tip_without_actions': 'Tip: You can type above to generate content'
        },
        'emptyPrompt': 'Please enter content',
        'driverMissing': 'No driver found'
    },
    // dialogs/contentimport/* 导入文档弹窗文案
    'contentimport': {
        'static': {
            'lang_select_local_file': 'Select Local File',
            'lang_paste_markdown': 'Paste Markdown',
            'lang_supported_formats': 'Supported Formats',
            'lang_confirm': 'Confirm',
            'lang_close': 'Close'
        },
        'wordConverting': 'Converting Word file, please wait...',
        'markdownConverting': 'Converting Markdown file, please wait...',
        'convertSuccess': 'Conversion successful',
        'wordConvertFail': 'Word file conversion failed: ',
        'markdownConvertFail': 'Markdown file conversion failed: ',
        'unsupportedFormat': 'Unsupported file format: ',
        'pleaseUploadFirst': 'Please upload a file first'
    },
    // dialogs/wordimage/* 图片转存弹窗文案
    wordimage: {
        'static': {
            lang_resave: "The re-save step",
            uploadBtn: {src: "upload.png", alt: "Upload"},
            clipboard: {style: "background: url(copy.png) -153px -1px no-repeat;"},
            lang_step: "1. Click the copy button above to copy the path. 2. Choose local files and paste the copied path in the file chooser. 3. Click confirm.",
            lang_copy_path: 'Copy Path',
            lang_save_from_local: 'Choose Local File',
            lang_windows_guide: 'Windows Guide',
            lang_mac_guide: 'Mac Guide',
            lang_windows_step_1: '1. Click the copy address button',
            lang_windows_step_2: '2. Click choose local file and paste the clipboard path into the chooser path field',
            lang_windows_step_3: '3. Click confirm',
            lang_mac_step_1: '1. Click the copy address button',
            lang_mac_step_2: '2. Click choose local file, press Command+Shift+G, and paste the clipboard path into the chooser path field',
            lang_mac_step_3: '3. Click confirm'
        },
        fileType: "Image",
        ...
        chooseFiles: 'Please choose: ',
        chooseFilesSuffix: '{#count} file(s) total',
        imageTransferSuccess: 'Image {#index} ({#name}) transferred successfully',
        transferFail: 'Upload failed: ',
        transferSuccessConfirm: 'Transfer successful, please confirm',
